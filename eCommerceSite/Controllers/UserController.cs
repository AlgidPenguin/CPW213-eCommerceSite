    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel reg)
        {
            if(ModelState.IsValid)
            {
                ...
                // if so, add custom error and send it back to view
                if(isEmailTaken)
                {
                    ModelState.AddModelError(nameof(RegisterViewModel.Email), "The email entered is already in use.");
                }
                ...
                if(isUsernameTaken)
                {
                    ModelState.AddModelError(nameof(RegisterViewModel.Username), "The username entered is taken.");
                }
